...
;(function($) {
	...
	$.timeliner = function(options){
		...
		settings = jQuery.extend({
			...
			expandAllText: '+ mostrar todas', // value: string, sets the text of the expandAll selector after the timeline is fully collapsed
			collapseAllText: '- ocultar todas' // // value: string, sets the text of the expandAll selector after the timeline is fully expanded
		}, options);
